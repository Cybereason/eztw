...
INSTALL_DIR=$(python -c "import os, eztw; print(os.path.dirname(eztw.__file__))")
pip install -r ../test_requirements.txt
pytest -r a --verbose ${INSTALL_DIR} --cov=eztw --cov-report html:cov_html --cov-report term ${PYTEST_ARGS:-}
if (which zip); then
